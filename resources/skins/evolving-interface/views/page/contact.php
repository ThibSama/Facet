...
<p class="mt-4 max-w-prose text-slate-700">Send a message and it will reach me directly.</p>
...
<form class="mt-8 max-w-md space-y-4" method="post" action="<?= $view->url('/contact') ?>">
    <p>
        ...
        <input class="mt-1 w-full rounded border border-slate-300 px-3 py-2"
    ...
    <p>
        ...
        <textarea class="mt-1 w-full rounded border border-slate-300 px-3 py-2"
                  id="contact-message" name="message" rows="6" required></textarea>
    </p>
    <p>
        <button class="rounded bg-slate-900 px-4 py-2 text-white" type="submit">Send</button>
    </p>
</form>
<?php
